...
var HashSchema = new mongoose.Schema({
    id:String,   //定义一个属性id，类型为String
    hash:String  //定义一个属性hash,类型为String
});
var HashModel = db.model('id',HashSchema);
var num = 0;
var addMongodb = function(hashid,hashInfo)
{
    console.log("write");
   
    db.once('open', function () {

        var MDragon = {id:hashid,hash:hashInfo};
        console.log(MDragon.id);
        HashModel.create(MDragon,function(){console.log("over")});
    });
   // db.close();
}
